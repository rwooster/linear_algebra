...
def get_intersection(lhs, rhs):
    if lhs == rhs:
        raise ValueError("{} is the same line as {}, no interection.".format(lhs, rhs))
    if are_parallel(lhs, rhs):
        raise ValueError("{} is parallel to {}, no intersection.".format(lhs, rhs))
